...
class ReadersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reader" do
    assert_difference('Reader.count') do
      post readers_url, params: { reader: { adress: @reader.adress, fathername: @reader.fathername, firstname: @reader.firstname, lastname: @reader.lastname, lib_id: @reader.lib_id, number: @reader.number, phone: @reader.phone } }
    end
  ...
  test "should update reader" do
    patch reader_url(@reader), params: { reader: { adress: @reader.adress, fathername: @reader.fathername, firstname: @reader.firstname, lastname: @reader.lastname, lib_id: @reader.lib_id, number: @reader.number, phone: @reader.phone } }
